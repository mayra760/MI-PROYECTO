...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-10-2024 a las 19:55:35
...
CREATE TABLE `tb_favoritos` (
  `id_favo` int(11) NOT NULL,
  `nombre_produc` varchar(50) NOT NULL,
  `cantidad_fav` int(11) NOT NULL,
...
/* 
Estructura de tabla de productos con likes
Como no puedes crear una vista, este bloque no es necesario
Puedes usar esta consulta SQL directamente en tu aplicación cuando lo necesites.
La tabla temporal `vista_productos_likes` no es necesaria, así que este bloque puede ser eliminado.
*/

/* 
Consulta que reemplaza la vista `vista_productos_likes`
Utiliza esta consulta en tu aplicación o en tu código SQL.
*/
...
--
ALTER TABLE `tb_carrito`
  MODIFY `id_ca` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `tb_conteo_eli`
  MODIFY `id_conteo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `tb_conteo_productos`
--
ALTER TABLE `tb_conteo_productos`
  MODIFY `id_conteo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de la tabla `tb_conteo_reg`
--
ALTER TABLE `tb_conteo_reg`
  MODIFY `id_conteo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tb_favoritos`
  MODIFY `id_favo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
